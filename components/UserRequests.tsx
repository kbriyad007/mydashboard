          ...
          <div className="relative bg-white dark:bg-gray-900 p-6 md:p-8 rounded-2xl shadow-xl max-w-sm w-full border border-gray-200 dark:border-gray-700">
            ...
            <div className="space-y-4 text-sm text-gray-700 dark:text-gray-300">
              <div className="flex items-center gap-2">
                ...
                <span className="ml-auto text-right">{selectedOrder["Customer-Name"]}</span>
              </div>
              <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  className="ml-auto text-right text-blue-600 hover:underline"
                >
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="ml-auto text-right">{selectedOrder["Product-Name"] || "N/A"}</span>
              </div>
              <div className="flex items-center gap-2">
                <Package size={16} className="text-gray-500" />
                <span className="font-medium">Quantity:</span>
                <span className="ml-auto text-right">{selectedOrder.Quantity}</span>
              </div>
            </div>
          </div>
        </div>
